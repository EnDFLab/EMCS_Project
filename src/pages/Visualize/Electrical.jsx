...
const Electrical = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch("http://127.0.0.1:5000/api/electrical-data");
  ...
  return (
    <div className="w-full bg-white rounded-lg shadow-md p-6">
      ...
      <h3 className="text-l text-[#48bdd5] font-bold mb-4">Department of Electrical and Electronics</h3>
